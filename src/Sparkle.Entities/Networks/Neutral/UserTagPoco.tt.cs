...
{
    public partial class UserTagPoco
    {
        ...
        {
            if (previousValue != null && previousValue.UserTags.Contains(this))
            {
            ...
            {
                if (!TagDefinition.UserTags.Contains(this))
                {
                    TagDefinition.UserTags.Add(this);
                }
        ...
        private void FixupUser(UserPoco previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.UserTags.Contains(this))
                {
                    User.UserTags.Add(this);
                }
                if (UserId != User.Id)
                {
                    UserId = User.Id;
        ...
        {
            if (previousValue != null && previousValue.CreatedUserTags.Contains(this))
            {
                previousValue.CreatedUserTags.Remove(this);
            }
    
            if (CreatedByUser != null)
            {
                if (!CreatedByUser.CreatedUserTags.Contains(this))
                {
                    CreatedByUser.CreatedUserTags.Add(this);
                }
        ...
        {
            if (previousValue != null && previousValue.DeletedUserTags.Contains(this))
            {
                previousValue.DeletedUserTags.Remove(this);
            }
    
            if (DeletedByUser != null)
            {
                if (!DeletedByUser.DeletedUserTags.Contains(this))
                {
                    DeletedByUser.DeletedUserTags.Add(this);
                }
