...
{
    public partial class InformationNotePoco
    {
        ...
        {
            if (previousValue != null && previousValue.InformationNotes.Contains(this))
            {
                previousValue.InformationNotes.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.InformationNotes.Contains(this))
                {
                    User.InformationNotes.Add(this);
                }
                if (UserId != User.Id)
                {
                    UserId = User.Id;
        ...
        private void FixupNetwork(NetworkPoco previousValue)
        {
            ...
            if (Network != null)
            {
                if (!Network.InformationNotes.Contains(this))
                {
                    Network.InformationNotes.Add(this);
                }
