...
{
    public partial class ExchangeMaterialPoco
    {
        ...
        {
            if (previousValue != null && previousValue.ExchangeMaterials.Contains(this))
            {
                previousValue.ExchangeMaterials.Remove(this);
            }
    
            if (Company != null)
            {
                if (!Company.ExchangeMaterials.Contains(this))
                {
                    Company.ExchangeMaterials.Add(this);
                }
        ...
        private void FixupUser(UserPoco previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.ExchangeMaterials.Contains(this))
                {
                    User.ExchangeMaterials.Add(this);
                }
        ...
        private void FixupNetwork(NetworkPoco previousValue)
        {
            ...
            if (Network != null)
            {
                if (!Network.ExchangeMaterials.Contains(this))
                {
                    Network.ExchangeMaterials.Add(this);
                }
