...
{
    public partial class CompaniesVisitPoco
    {
        ...
        {
            if (previousValue != null && previousValue.CompaniesVisits.Contains(this))
            {
                previousValue.CompaniesVisits.Remove(this);
            }
    
            if (Company != null)
            {
                if (!Company.CompaniesVisits.Contains(this))
                {
                    Company.CompaniesVisits.Add(this);
                }
        ...
        private void FixupUser(UserPoco previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.CompaniesVisits.Contains(this))
                {
                    User.CompaniesVisits.Add(this);
                }
                if (UserId != User.Id)
                {
                    UserId = User.Id;
