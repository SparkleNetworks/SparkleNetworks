...
{
    public partial class LostItemPoco
    {
        ...
        {
            if (previousValue != null && previousValue.LostItems.Contains(this))
            {
                previousValue.LostItems.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.LostItems.Contains(this))
                {
                    User.LostItems.Add(this);
                }
                if (UserId != User.Id)
                {
                    UserId = User.Id;
        ...
        private void FixupNetwork(NetworkPoco previousValue)
        {
            ...
            if (Network != null)
            {
                if (!Network.LostItems.Contains(this))
                {
                    Network.LostItems.Add(this);
                }
